...
public class CartaJF extends javax.swing.JFrame {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (cartaSel == null) {
            ...
            CadastroCartaJD telaCadastro = new CadastroCartaJD(this, true);
            telaCadastro.setAllCartas(cartaSel); 
            telaCadastro.setVisible(true);

            Carta cartaEditada = telaCadastro.getCartaEdit();
            if (cartaEditada != null) {
                ...
                try {
                    jpa.persist(cartaEditada); // Atualiza no banco
                } catch (Exception ex) {
                    System.err.println("ERRO AO EDITAR CARTA: " + ex);
                }

                loadCards(); // Atualiza a lista na tela
            }
        }
