...
public class CadastroCartaJD extends javax.swing.JDialog {
    private Carta carta;
    private Carta cartaEditando = null;
    ...
    public void setAllCartas(Carta c) {
        this.cartaEditando = c;

        // Preenche os campos com os dados existentes
        txtNome.setText(c.getNome());
        txtAtaque.setText(String.valueOf(c.getAtaque()));
        txtDefesa.setText(String.valueOf(c.getDefesa()));
        cmbCategoria.setSelectedItem(c.getCategoria());
    }
    
    public Carta getCartaEdit() {
        return cartaEditando;
    }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        // int raridade = (int) spnRaridade.getValue();

        if (cartaEditando == null) {
            cartaEditando = new Carta();
        }

        cartaEditando.setNome(nome);
        cartaEditando.setAtaque(ataque);
        cartaEditando.setDefesa(defesa);
        cartaEditando.setCategoria(categoria);
        // cartaEditando.setRaridade(raridade);
